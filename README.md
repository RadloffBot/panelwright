...
- **[NEC Article 235 — Circuits Over 1000 V, Nominal (2023): the brand-new medium-voltage branch-circuit, feeder, and service article](articles/nec-235-circuits-over-1000v.html)**
  ...
  checks.
- **[`articles/nec-40801-40858-switchboards-switchgear-panelboards.html`](articles/nec-40801-40858-switchboards-switchgear-panelboards.html)**
  Article 67 — the "how must a switchboard, switchgear, or panelboard be rated, protected, and marked?" article. All 60 on-disk 2023 rows of NEC Article 408 (408.1–408.58, Parts I–V) verbatim from the on-disk 2023 dataset, all 27 on-disk 2017 sections verbatim from the on-disk NFPA scan, the 408.3/408.4 panelboard rating rules (600 A busbar / 800 A enclosure cap, the 125%-of-continuous-load rule), 408.36–408.38 overcurrent protection (including the 408.38(B) fuses-only exception), 408.41–408.47 short-circuit-current rating (the 408.42 65 kA / 408.45 100 kA thresholds), the 2023-new sections (408.6 reconditioned, 408.9/408.21/408.23/408.43), the on-disk 2020 source showing no Article 408 body (cross-reference only — 2020 gap disclosed), and the on-disk Mike Holt 2023 change entries for 408.43/408.5/408.56. Seventeen machine-diffed 2017→2023 deltas (one number moved: 408.2 became reconditioned equipment), six core-computed worked examples (zero hand math). Machine-verified checks.
- **[`articles/nec-40601-40613-receptacles-attachment-plugs.html`](articles/nec-40601-40613-receptacles-attachment-plugs.html)**
  Article 68 — the "what device, what rating, what place?" article. All 67 on-disk 2023 rows of NEC Article 406 (406.1–406.13) verbatim from the on-disk 2023 dataset, all 12 on-disk 2017 sections verbatim from the on-disk NFPA scan, the 406.3(B) 15 A / 125 V rating floor, the 2023-new 406.3(D) termination rules (15 A / 14 AWG push-in corner + CO/ALR copper-clad), the 406.4(D)(1)–(8) replacement rules (GFCI-listed sentence, GFPE, the 210.12(C) AFCI extension, automatically-controlled replacements), the 406.5(G)(2) below-sink face-up ban, the 406.6(D) 1 W night-light/USB faceplate limit (2026 steel-screw Exception), the 406.9 wet-location rework (90-degree hinged covers, the 900 mm × 2.5 m bathtub/shower zone + 4 exceptions), the 406.12 expansion (7 → 10 required locations), and the brand-new 406.13 single-pole separable-connector section (sequential EGC-first interlock, ANSI-UL 1691). The 2020 on-disk source carries no Article 406 body (cross-reference only — 2020 gap disclosed); the five on-disk Mike Holt 2023 change entries (406.3/406.4/406.6/406.9/406.12) are quoted verbatim. 21 machine-diffed 2017→2023 deltas, six core-computed worked examples (zero hand math). Machine-verified checks.
- **[`articles/nec-40401-40430-switches-2017-2023.html`](articles/nec-40401-40430-switches-2017-2023.html)**
  Article 69 — the "what switch, what rating, what place?" article. All 47 on-disk 2023 rows of NEC Article 404 (404.1–404.30) verbatim from the on-disk 2023 dataset, all 19 on-disk 2017 sections verbatim from the on-disk NFPA scan (disclosed OCR artifacts), the 404.2(C) grounded-conductor rule (5 per branch / 25 per feeder electronic-control switches), the 404.8(A) 2.0 m (6 ft 7 in.) handle-height line, the 404.8(B) 300 V adjacent-device limit, the 404.13 knife-switch 1200 A / 1000 A / 600 A seams, the 404.14 rating/switch-form rework (LED/ballast loads in (A)/(B)/(E), the NEW 404.14(D) termination rules — 15 A push-in branch cap / 14 AWG solid copper only — the switch-side mirror of 406.3(D)), the brand-new 404.16 reconditioned-switch section (lighting/dimmer/electronic + snap + molded-case banned; knife/butt/bolted permitted with fire/water damage evaluation), and the brand-new 404.30 closed-door interior-access restriction. The 2020 on-disk source carries no Article 404 body (TOC + code-making-panel citation only — 2020 gap disclosed); the two on-disk Mike Holt 2023 change entries (404.1/404.14) are quoted verbatim. 29 machine-diffed 2017→2023 deltas, six core-computed worked examples (zero hand math). Machine-verified checks.
